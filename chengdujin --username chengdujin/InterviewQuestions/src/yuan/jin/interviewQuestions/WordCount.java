...
/**
 * Implement the Unix command WordCount (wc) using language of your choice. The
 * method takes a string and returns the number of words in the string, number
 * of chars and the number of lines.
 * 
 * @author Yuan
 * 
 */
